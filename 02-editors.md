...
>> Vim will be my terminal editor. It seems to have the right balance between functionality and ease of use.
...
>> Sublime will be my graphical editor since I have experience using it from before.
